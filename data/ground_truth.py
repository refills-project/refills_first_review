...
class GroundTruth:
    ...
    def print_tree(self, frame, depth = 0):
        s = ""
...
def instantiate_ground_truth():
    ...
    gt.add_frame("shelf1_root", "shelf_layer1", Vector3d(0.02, layer_to_barcode_z, 0.14))

    gt.add_frame("shelf_layer1", "shelf_layer1_seperator_1", Vector3d(0.03, layer_to_seperator_y, layer_to_seperator_z))
    gt.add_frame("shelf_layer1", "shelf_layer1_seperator_2", Vector3d(0.1, layer_to_seperator_y, layer_to_seperator_z))
    gt.add_frame("shelf_layer1", "shelf_layer1_seperator_3", Vector3d(0.24, layer_to_seperator_y, layer_to_seperator_z))
    gt.add_frame("shelf_layer1", "shelf_layer1_seperator_4", Vector3d(0.382, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer1", "shelf_layer1_seperator_5", Vector3d(0.511, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer1", "shelf_layer1_seperator_6", Vector3d(0.64, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer1", "shelf_layer1_seperator_7", Vector3d(0.766, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer1", "shelf_layer1_seperator_8", Vector3d(0.867, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer1", "shelf_layer1_seperator_9", Vector3d(0.98, layer_to_seperator_z, layer_to_seperator_z))

    gt.add_frame("shelf_layer1", "027995", Vector3d(0.03, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer1", "544205", Vector3d(0.162, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer1", "384160", Vector3d(0.297, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer1", "457319", Vector3d(0.428, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer1", "534812", Vector3d(0.572, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer1", "402610", Vector3d(0.697, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer1", "433961", Vector3d(0.806, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer1", "507923", Vector3d(0.917, layer_to_barcode_y, layer_to_barcode_z))

    gt.add_frame("shelf_layer1", "shelf_layer2", Vector3d(0, 0.102, 0.4))

    gt.add_frame("shelf_layer2", "shelf_layer2_seperator_1", Vector3d(0.03, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer2", "shelf_layer2_seperator_2", Vector3d(0.155, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer2", "shelf_layer2_seperator_3", Vector3d(0.218, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer2", "shelf_layer2_seperator_4", Vector3d(0.28, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer2", "shelf_layer2_seperator_5", Vector3d(0.361, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer2", "shelf_layer2_seperator_6", Vector3d(0.561, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer2", "shelf_layer2_seperator_7", Vector3d(0.609, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer2", "shelf_layer2_seperator_8", Vector3d(0.749, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer2", "shelf_layer2_seperator_9", Vector3d(0.858, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer2", "shelf_layer2_seperator_10", Vector3d(0.98, layer_to_seperator_z, layer_to_seperator_z))

    gt.add_frame("shelf_layer2", "500183", Vector3d(0.065, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer2", "046088", Vector3d(0.197, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer2", "262289", Vector3d(0.302, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer2", "010055", Vector3d(0.414, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer2", "015652", Vector3d(0.538, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer2", "516937", Vector3d(0.664, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer2", "125481", Vector3d(0.906, layer_to_barcode_y, layer_to_barcode_z))

    gt.add_frame("shelf_layer2", "shelf_layer3", Vector3d(0 ,0, 0.34))

    gt.add_frame("shelf_layer3", "shelf_layer3_seperator_1", Vector3d(0.030, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer3", "shelf_layer3_seperator_2", Vector3d(0.150, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer3", "shelf_layer3_seperator_3", Vector3d(0.364, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer3", "shelf_layer3_seperator_4", Vector3d(0.513, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer3", "shelf_layer3_seperator_5", Vector3d(0.771, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer3", "shelf_layer3_seperator_6", Vector3d(0.857, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer3", "shelf_layer3_seperator_7", Vector3d(0.999, layer_to_seperator_z, layer_to_seperator_z))

    gt.add_frame("shelf_layer3", "004728", Vector3d(0.056, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer3", "196068", Vector3d(0.240, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer3", "332384", Vector3d(0.426, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer3", "523129", Vector3d(0.584, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer3", "424929", Vector3d(0.772, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer3", "235542", Vector3d(0.902, layer_to_barcode_y, layer_to_barcode_z))

    gt.add_frame("shelf_layer3", "shelf_layer4", Vector3d(0 ,0, 0.298))

    gt.add_frame("shelf_layer4", "shelf_layer4_seperator_1", Vector3d(0.030, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer4", "shelf_layer4_seperator_2", Vector3d(0.181, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer4", "shelf_layer4_seperator_3", Vector3d(0.294, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer4", "shelf_layer4_seperator_4", Vector3d(0.433, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer4", "shelf_layer4_seperator_5", Vector3d(0.625, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer4", "shelf_layer4_seperator_6", Vector3d(0.824, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer4", "shelf_layer4_seperator_7", Vector3d(0.990, layer_to_seperator_z, layer_to_seperator_z))

    gt.add_frame("shelf_layer4", "114035", Vector3d(0.068, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer4", "176671", Vector3d(0.217, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer4", "422771", Vector3d(0.328, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer4", "331372", Vector3d(0.498, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer4", "377954", Vector3d(0.701, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer4", "227003", Vector3d(0.874, layer_to_barcode_y, layer_to_barcode_z))

    gt.add_frame("shelf_layer4", "shelf_layer5", Vector3d(0 ,0, 0.255))

    gt.add_frame("shelf_layer5", "shelf_layer5_seperator_1", Vector3d(0.030, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer5", "shelf_layer5_seperator_2", Vector3d(0.109, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer5", "shelf_layer5_seperator_3", Vector3d(0.308, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer5", "shelf_layer5_seperator_4", Vector3d(0.571, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer5", "shelf_layer5_seperator_5", Vector3d(0.774, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer5", "shelf_layer5_seperator_6", Vector3d(0.980, layer_to_seperator_z, layer_to_seperator_z))

    gt.add_frame("shelf_layer5", "200563", Vector3d(0.030, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer5", "447600", Vector3d(0.186, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer5", "501155", Vector3d(0.412, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer5", "501156", Vector3d(0.662, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer5", "534910", Vector3d(0.861, layer_to_barcode_y, layer_to_barcode_z))

    gt.add_frame("shelf_layer5", "shelf_layer6", Vector3d(0 ,0, 0.338))

    gt.add_frame("shelf_layer6", "shelf_layer6_seperator_1", Vector3d(0.030, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer6", "shelf_layer6_seperator_2", Vector3d(0.111, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer6", "shelf_layer6_seperator_3", Vector3d(0.201, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer6", "shelf_layer6_seperator_4", Vector3d(0.282, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer6", "shelf_layer6_seperator_5", Vector3d(0.358, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer6", "shelf_layer6_seperator_6", Vector3d(0.425, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer6", "shelf_layer6_seperator_7", Vector3d(0.513, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer6", "shelf_layer6_seperator_8", Vector3d(0.648, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer6", "shelf_layer6_seperator_9", Vector3d(0.728, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer6", "shelf_layer6_seperator_10", Vector3d(0.814, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer6", "shelf_layer6_seperator_11", Vector3d(0.886, layer_to_seperator_z, layer_to_seperator_z))
    gt.add_frame("shelf_layer6", "shelf_layer6_seperator_12", Vector3d(0.982, layer_to_seperator_z, layer_to_seperator_z))

    gt.add_frame("shelf_layer6", "305553", Vector3d(0.044, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer6", "503131", Vector3d(0.140, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer6", "333192", Vector3d(0.219, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer6", "333140", Vector3d(0.306, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer6", "050081", Vector3d(0.371, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer6", "454259", Vector3d(0.453, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer6", "048180", Vector3d(0.565, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer6", "046445", Vector3d(0.670, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer6", "500124", Vector3d(0.755, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer6", "333154", Vector3d(0.837, layer_to_barcode_y, layer_to_barcode_z))
    gt.add_frame("shelf_layer6", "023130", Vector3d(0.923, layer_to_barcode_y, layer_to_barcode_z))



    gt.add_frame("root", "shelf2_root", Vector3d(2,0,0))
    gt.add_frame("shelf2_root", "shelf2_layer1", Vector3d(0.02, -0.035, 0.14))
    ...
    gt.add_frame("shelf3_root", "shelf3_layer1", Vector3d(0.02, -0.035, 0.14))

    gt.add_frame("shelf3_layer1", "shelf3_layer1_seperator_1", Vector3d(0.030, layer_to_seperator_y, layer_to_seperator_z))
    ...
    gt.add_frame("shelf3_layer2", "shelf3_layer2_seperator_1", Vector3d(0.030, layer_to_seperator_y, layer_to_seperator_z))
    ...
    gt.add_frame("shelf3_layer3", "shelf3_layer3_seperator_1", Vector3d(0.030, layer_to_seperator_y, layer_to_seperator_z))
    ...
    gt.add_frame("shelf3_layer4", "shelf3_layer4_seperator_1", Vector3d(0.030, layer_to_seperator_y, layer_to_seperator_z))
    ...
    #gt.print_tree(gt.root)
    t1 = gt.get_vector_between_frames("shelf1_root","023130")
    t2 = gt.get_vector_between_frames("305553","500124")
    t3 = gt.get_vector_between_frames("shelf_layer5_seperator_3","shelf_layer3")
    #t = gt.get_vector_between_frames("root","shelf_layer1")
    print(str(t1))
    print(str(t2))
    print(str(t3))
